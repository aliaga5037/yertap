...
const LocationFilter = () => {
  ...
  const cityTitle = (
    <span className="flex items-center gap-2">
      <i className="icon icon-gps flex" />
      <span>{city}</span>
    </span>
  );
  ...
  const districtTitle = (
    <span className="flex items-center gap-2">
      <i className="icon icon-district flex" />
      <span>{district[0] || 'Select District'}</span>
    </span>
  );
  return (
    <div>
      ...
      <div className="mb-4">
        ...
        <Dropdown title={cityTitle} className="mr-1 w-full">
          <div className="flex flex-col rounded-lg border border-gray-light3 bg-white">
            <span
      ...
      <>
        ...
        <Dropdown title={districtTitle} className="mr-1 mb-4 w-full">
